        ...
        <?php include "header.html"; ?>            
            ...
            <div class="card card-5">
                ...
                <div class="card-body" style="text-align: center;">                      
                    <p>
                        <font color="#0c40f0">
                            <h3><b>Welcome to KCET, you are now connected with us.<br> We will contact you soon...</b></h3>
                        </font>                            
                    </p>
                    <br>
                    <a class = 'btn btn--radius btn--blue' href="studentslogin.php">Back</a>
