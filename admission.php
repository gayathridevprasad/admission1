        ...
        <div class="wrapper wrapper--w790">
            ...
            <div class="card card-5">
                ...
                <div class="card-body" style="text-align: center;">                      
                    <div>
                        <a class = 'btn btn--radius btn--blue' href="meadmission.php">M.E/M.Tech Admission</a><br><br>
                        <a class = 'btn btn--radius btn--blue' href="studentslogin.php">B.E/B.Tech Admission</a><br><br>
                        <a class = 'btn btn--radius btn--blue' href="lateraladmission.php">Lateral Entry Admission</a><br><br>
                        <a class = 'btn btn--radius btn--blue' href="transadmission.php">Transfer Admission</a>        
                    </div>
                </div>
            </div>
        </div>
