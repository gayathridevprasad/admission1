...
<head>
    ...
    <!-- Title Page-->
    <title>Lateral Admission Page</title>
        ...
        <?php include "header.html"; ?>            
            ...
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Lateral Entry Admission</h2>
                </div>
                <div class="card-body" style="text-align: center;">                      
                	<iframe name="dis" frameborder=0 width="100%" height="800px" src="http://www.kamarajengg.edu.in/admission/lateral.html"></iframe>	
                </div>
            </div>
        </div>
