		...
		<form action="process-complete.php" method="post" id="form">
			...
			<table width="500">
			  ...
			  <tr>
				...
				<tr>
				<td><input type="text" name="sm[]" value="1" size="3" placeholder="Semester1" readonly /></td>
				...
				<tr>
				<td><input type="text" name="sm[]" size="3" value="1" placeholder="Semester1" readonly /></td>
				<td><input type="text" name="sn[]" value="" /></td>
				<td>
					<select id="branch" name="grade[]" >
					<option value="-1">Choose</option>
				...
				<tr>
				<td><input type="text" size="3" name="sm[]" value="1" placeholder="Semester1" readonly/></td>
				<td><input type="text" name="sn[]" value="" /></td>
				<td>
					<select id="branch" name="grade[]" >
					<option value="-1">Choose</option>
			  ...
			  <tr>
			  <td>Did you get the results for Semester - II</td>
			  </tr>
			  <tr>
			  <td>
			  ...
			  <tr>
				...
				<fieldset>
				<legend>Marks for Semester - II</legend>
				<table>
				<tr>
					<th><div align="center">Subject Name</div></th>
					<th ><div align="center">Grade Obtained</div></th>
				...
				<tr>
				<td><input type="text" name="sm[]" value="2" size="3" placeholder="Semester2" readonly/></td>
				<td><input type="text" name="sn[]" value=""  /></td>
				<td>
					<select id="branch" name="grade[]" >
					<option value="-1">Choose</option>
