		...
		<form action="process-complete.php" method="post" id="form">
			...
			<table width="500">
			  ...
			  <tr>
			    <td>
			    <fieldset>
				<legend>Marks for Semester - IV (<font color="red">*</font>)</legend>
				<table>
				<tr>
					<th ><div align="center">Semester No</div></th>
					<th ><div align="center">Subject Name</div></th>
				...
				<tr>
				<td><input type="text" name="sm[]" size="3" value="4" placeholder="Semester4" disabled/></td>
				<td><input type="text" name="sn[]" value="" /></td>
				<td>
					<select id="branch" name="grade[]" >
					<option value="-1">Choose</option>
				...
				<tr>
				<td><input type="text" size="3" name="sm[]" value="4" placeholder="Semester4" disabled/></td>
				<td><input type="text" name="sn[]" value="" /></td>
				<td>
					<select id="branch" name="grade[]" >
					<option value="-1">Choose</option>
			  ...
			  <tr>
			    <td>
			    <fieldset>
				<legend>Marks for Semester - V (<font color="red">*</font>)</legend>
				<table>
				<tr>
					<th ><div align="center">Semester No</div></th>
					<th ><div align="center">Subject Name</div></th>
				...
				<tr>
				<td><input type="text" name="sm[]" value="5" size="3" placeholder="Semester5" disabled/></td>
				<td><input type="text" name="sn[]" value=""  /></td>
				<td>
					<select id="branch" name="grade[]" >
					<option value="-1">Choose</option>
				...
				<tr>
				<td><input type="text" name="sm[]" size="3" value="5" placeholder="Semester5" disabled/></td>
				<td><input type="text" name="sn[]" value="" /></td>
				<td>
					<select id="branch" name="grade[]" >
					<option value="-1">Choose</option>
				...
				<tr>
				<td><input type="text" size="3" name="sm[]" value="5" placeholder="Semester5" disabled/></td>
				<td><input type="text" name="sn[]" value="" /></td>
				<td>
					<select id="branch" name="grade[]" >
					<option value="-1">Choose</option>
			  ...
			  <tr>
			  <td>Did you get the results for Semester - VI</td>
			  </tr>
			  <tr>
			  <td>
			  ...
			  <tr>
				...
				<fieldset>
				<legend>Marks for Semester - VI</legend>
				<table>
				<tr>
				...
				<tr>
				<td><input type="text" name="sm[]" value="6" size="3" placeholder="Semester6" disabled/></td>
				<td><input type="text" name="sn[]" value=""  /></td>
				<td>
					<select id="branch" name="grade[]" >
					<option value="-1">Choose</option>
				...
				<tr>
				<td><input type="text" name="sm[]" value="6" size="4" placeholder="Semester6" disabled/></td>
				<td><input type="text" name="sn[]" value="" /></td>
				<td>
					<select id="branch" name="grade[]" >
					<option value="-1">Choose</option>
